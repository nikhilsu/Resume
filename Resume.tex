...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheadingWithDescription
      ...
      \resumeItem{Food-Supplies Management}{Worked on a stock management tool to help the pantry of the office plan the supply of fruits, vegetables, and grocery better in order to minimize wastage of food. This tool was built using the \emph{sklearn} and \emph{keras} libraries in Python.}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
          ...
          \resumeItem{Household Security System}{Security system that provided live video-stream of the house under surveillance over the internet onto the owner's smart phone. The owner could also control the entrance gates of their house.}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
